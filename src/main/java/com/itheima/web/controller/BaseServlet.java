...
public class BaseServlet extends HttpServlet {
     ...
     * 解决：方法中的this表示，哪个对象调用该方法，this就表示哪个对象。
     * 当我们客户端发起请求访问CompanyServlet时，tomcat服务器会创建CompanyServlet对象，创建完成之后会调用init方法初始化，
     * 接着调用service方法，也就是companyServlet.service(request,response)，此时我们的companyServlet没有重写这个方法，
     * 那么就会使用父类BaseServlet中定义的service方法，所有此时父类BaseServlet的service方法中打印的this表示的是子类对象。
     */
    @Override
